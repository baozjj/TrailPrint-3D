# 迹印 TrailPrint 3D · UI 设计稿说明

## 设计文件

| 文件 | 说明 |
|------|------|
| [`迹印-TrailPrint-3D.pen`](../迹印-TrailPrint-3D.pen) | Pencil 主界面设计稿（1440×900） |
...
2. 打开项目根目录下的 `迹印-TrailPrint-3D.pen`
...
- **侧栏**：标题「迹印 / TrailPrint 3D」、导入 GPX、五个手风琴配置区（第 5 项默认折叠并标「高级」）、底部磨砂底栏 +「生成并下载 STL」主按钮
