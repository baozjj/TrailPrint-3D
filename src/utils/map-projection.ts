...
export function boundsSpanMeters(bounds: GpxBounds): { widthM: number; heightM: number } {
...
/** 根据边界与画布尺寸计算合适的缩放级别（内部单位，约 10–18） */
export function zoomToFitBounds(
  ...
  // mapZoom 与 metersPerPixel 反比：zoom 越大 mpp 越小
